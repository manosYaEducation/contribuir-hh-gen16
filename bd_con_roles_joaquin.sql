...
--
-- Host: localhost
-- Generation Time: Mar 06, 2026 at 02:48 PM
...
--
-- Database: `u125784517_contribuir_db`
--
...
INSERT INTO `courses` (`id`, `title`, `instructor`, `instructor_id`, `avatar`, `category`, `price`, `rating`, `students`, `duration`, `total_hours`, `level`, `image`, `description`) VALUES
(1, 'Formación de Artistas Educadores', 'Con Tribu Ir', NULL, 'https://i.ibb.co/84Kf9Rd0/552183644-17852106906549939-7631989156897828754-n.webp', 'Administración Educativa', 20000, 4.9, 204, '28 horas', NULL, NULL, 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=600&h=400&fit=crop', 'Somos una iniciativa pionera en Chile impulsada por CREO de Creer y Crear, Con Tribu Ir y la Red de Artistas Educadores de Chile (RAECH). Su propósito es profesionalizar y fortalecer el rol del \"Artista Educador\", integrando el arte no solo como una técnica, sino como una herramienta pedagógica para la educación emocional y la transformación social. El programa combina modelos teóricos, herramientas de gestión práctica (como formalización y planificación) y enfoques inclusivos (DUA y neurociencias) para preparar a los artistas en el desarrollo de experiencias educativas significativas en contextos escolares, culturales y psicosociales.'),
(2, 'Trabajo Colaborativo en I+D Aumentado con IA', 'Alpha Docere', NULL, 'photos/LogoAlphadocere.png', 'Innovación y Tecnología', 0, 4.8, 121, '4 semanas', NULL, NULL, 'photos/LogoAlphadocere.png', 'Curso online de 4 semanas enfocado en aprender a trabajar colaborativamente en entornos de investigación y desarrollo (I+D) utilizando inteligencia artificial como apoyo. Los participantes aprenderán a transformar ideas en problemas estructurados, formular hipótesis, documentar de manera clara, iterar con feedback y definir un camino personal dentro del ecosistema de innovación. No se requiere experiencia técnica previa.'),
(3, 'Fotografía Profesional con Cámara y Móvil', 'Carlos Rivas', NULL, 'https://i.ibb.co/84Kf9Rd0/552183644-17852106906549939-7631989156897828754-n.webp', 'Fotografía', 52000, 4.7, 200, '12 horas', NULL, NULL, 'photos/LogoOficial.png', 'Aprende composición, iluminación y edición para obtener fotos de calidad profesional con cualquier dispositivo.'),
(5, 'Yoga y Bienestar Integral', 'Fernanda López', NULL, 'https://i.ibb.co/84Kf9Rd0/552183644-17852106906549939-7631989156897828754-n.webp', 'Salud', 30000, 4.9, 152, '8 horas', NULL, NULL, 'photos/LogoOficial.png', 'Rutinas de yoga, respiración y relajación para mejorar tu salud física y mental.'),
(6, 'Inglés Conversacional Intensivo', 'John Peterson', NULL, 'https://i.ibb.co/84Kf9Rd0/552183644-17852106906549939-7631989156897828754-n.webp', 'Idiomas', 70000, 4.4, 98, '20 horas', NULL, NULL, 'photos/LogoOficial.png', 'Desarrolla fluidez en inglés con ejercicios prácticos de conversación en situaciones reales.'),
(7, 'Excel Avanzado para el Trabajo', 'Ricardo Muñoz', NULL, 'https://i.ibb.co/84Kf9Rd0/552183644-17852106906549939-7631989156897828754-n.webp', 'Ofimática', 40000, 4.6, 261, '14 horas', NULL, NULL, 'photos/LogoOficial.png', 'Funciones avanzadas, tablas dinámicas y automatización para mejorar tu productividad laboral.');
...
INSERT INTO `users` (`id`, `name`, `email`, `password_hash`, `role_id`, `image`, `description`, `created_at`) VALUES
(1, 'Tomas', 'tomas@tomas.cl', '$2y$10$9kerykRLBUak8yNInuoon.eYwxr0WaVyIdBf71ACEUu255u5ylaqW', 3, NULL, NULL, '2025-10-11 21:20:58'),
(2, 'test', 'test@test.cl', '$2y$10$RgP6CfKgG9AyWcRwZwNh8.wF4z4eA.wNSPCQTr5fBTqXPlmiyynT6', 3, NULL, NULL, '2025-10-11 23:15:21'),
(3, 'AlonsoDeus', 'Alonso@Diaz.cl', '$2y$10$e8jkjjR.9pFbMsz9MRdi4eqRTxMPLV9Z2iue2a4oVXbrvVZnkAH3K', 3, NULL, NULL, '2025-10-14 13:07:41'),
(4, 'Joaco', 'joaco@joaco.cl', '$2y$10$rnNNjAXEMIX58Zur5lh5re/ggei9UZXEOvA2FOKJI/orBZ7R9YY56', 3, NULL, NULL, '2025-10-14 21:30:05'),
(5, 'Arturo Quiroga Tello', 'arturo@arturo.cl', '$2y$10$pNs4w/ZlsaLDbmNXpZpll.0vCSQNkWlmciQKJFYihxVRagL2uTr8y', 3, NULL, NULL, '2026-02-13 13:46:29'),
(6, 'joaquin', 'joaquinperaltacorbellini24@gmail.com', '$2y$10$3YUv34Y3YOxmSvrVAzz0wOhtgijHRs8F7Dx.lwr2SHYsxaWZp8QQ6', 1, NULL, NULL, '2026-03-03 19:41:24');
...
--
-- Indexes for table `detail_courses`
--
...
--
-- AUTO_INCREMENT for table `detail_courses`
--
ALTER TABLE `detail_courses`
...
--
-- Constraints for table `detail_courses`
--
ALTER TABLE `detail_courses`
