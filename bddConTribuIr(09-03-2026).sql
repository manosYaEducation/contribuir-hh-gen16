-- ============================================================
-- Script FINAL consolidado - Base de datos contribuir_db
-- Fecha de merge: 2026-03-08
-- Fusión de: BD original + roles/permisos + recuperación de contraseña
-- Cambios aplicados:
--   1. Tablas nuevas: roles, permissions, role_permissions, login_attempts
--   2. Tabla users: +role_id (FK→roles), +image, +description,
--      +reset_code, +reset_code_expires_at
--   3. Tabla courses: eliminado campo 'instructor' varchar,
--      instructor_id INT NOT NULL (FK→users), +total_hours, +level
-- ============================================================
...
(2, 'instructor', 'Puede crear y gestionar sus propios cursos'),
(3, 'student', 'Usuario estándar, puede inscribirse a cursos');
...
(1, 'course.create', 'Crear nuevos cursos'),
(2, 'course.edit_own', 'Editar cursos propios'),
(3, 'course.edit_any', 'Editar cualquier curso'),
(4, 'course.delete_own', 'Eliminar cursos propios'),
(5, 'course.delete_any', 'Eliminar cualquier curso'),
(6, 'course.view', 'Ver listado de cursos'),
(7, 'user.manage', 'Gestionar usuarios');
...
-- Campos nuevos: role_id, image, description, reset_code, reset_code_expires_at
--
CREATE TABLE `users` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
...
--
INSERT INTO `users` (`id`, `name`, `email`, `password_hash`, `role_id`, `image`, `description`, `reset_code`, `reset_code_expires_at`, `created_at`) VALUES
(1, 'Tomas', 'tomas@tomas.cl', '$2y$10$9kerykRLBUak8yNInuoon.eYwxr0WaVyIdBf71ACEUu255u5ylaqW', 3, NULL, NULL, NULL, NULL, '2025-10-11 21:20:58'),
(2, 'test', 'test@test.cl', '$2y$10$RgP6CfKgG9AyWcRwZwNh8.wF4z4eA.wNSPCQTr5fBTqXPlmiyynT6', 3, NULL, NULL, NULL, NULL, '2025-10-11 23:15:21'),
(3, 'AlonsoDeus', 'Alonso@Diaz.cl', '$2y$10$e8jkjjR.9pFbMsz9MRdi4eqRTxMPLV9Z2iue2a4oVXbrvVZnkAH3K', 3, NULL, NULL, NULL, NULL, '2025-10-14 13:07:41'),
(4, 'Joaco', 'joaco@joaco.cl', '$2y$10$rnNNjAXEMIX58Zur5lh5re/ggei9UZXEOvA2FOKJI/orBZ7R9YY56', 3, NULL, NULL, NULL, NULL, '2025-10-14 21:30:05'),
(5, 'Arturo Quiroga Tello', 'arturo@arturo.cl', '$2y$10$pNs4w/ZlsaLDbmNXpZpll.0vCSQNkWlmciQKJFYihxVRagL2uTr8y', 3, NULL, NULL, NULL, NULL, '2026-02-13 13:46:29'),
(6, 'joaquin', 'joaquinperaltacorbellini24@gmail.com', '$2y$10$3YUv34Y3YOxmSvrVAzz0wOhtgijHRs8F7Dx.lwr2SHYsxaWZp8QQ6', 1, NULL, NULL, NULL, NULL, '2026-03-03 19:41:24');
...
--
INSERT INTO `role_permissions` (`id`, `role_id`, `permission_id`, `allowed`) VALUES
(1, 1, 1, 1),
(2, 1, 5, 1),
(3, 1, 4, 1),
(4, 1, 3, 1),
...
-- Cambios: eliminado 'instructor' varchar, instructor_id NOT NULL FK→users,
--          agregados total_hours y level
--
...
-- NOTA: instructor_id referencia users(id).
--   Cursos 1,2 usan instructor_id de la BD original.
--   Cursos 3,5,6,7 asignados al admin (id=6) como placeholder.
--   Ajustar cuando se creen las cuentas de instructor correspondientes.
--
INSERT INTO `courses` (`id`, `title`, `instructor_id`, `avatar`, `category`, `price`, `rating`, `students`, `duration`, `total_hours`, `level`, `image`, `description`) VALUES
(1, 'Formación de Artistas Educadores', 1, 'https://i.ibb.co/84Kf9Rd0/552183644-17852106906549939-7631989156897828754-n.webp', 'Administración Educativa', 20000, 4.9, 204, '28 horas', NULL, NULL, 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=600&h=400&fit=crop', 'Somos una iniciativa pionera en Chile impulsada por CREO de Creer y Crear, Con Tribu Ir y la Red de Artistas Educadores de Chile (RAECH). Su propósito es profesionalizar y fortalecer el rol del \"Artista Educador\", integrando el arte no solo como una técnica, sino como una herramienta pedagógica para la educación emocional y la transformación social. El programa combina modelos teóricos, herramientas de gestión práctica (como formalización y planificación) y enfoques inclusivos (DUA y neurociencias) para preparar a los artistas en el desarrollo de experiencias educativas significativas en contextos escolares, culturales y psicosociales.'),
(2, 'Trabajo Colaborativo en I+D Aumentado con IA', 2, 'photos/LogoAlphadocere.png', 'Innovación y Tecnología', 0, 4.8, 121, '4 semanas', NULL, NULL, 'photos/LogoAlphadocere.png', 'Curso online de 4 semanas enfocado en aprender a trabajar colaborativamente en entornos de investigación y desarrollo (I+D) utilizando inteligencia artificial como apoyo. Los participantes aprenderán a transformar ideas en problemas estructurados, formular hipótesis, documentar de manera clara, iterar con feedback y definir un camino personal dentro del ecosistema de innovación. No se requiere experiencia técnica previa.'),
(3, 'Fotografía Profesional con Cámara y Móvil', 6, 'https://i.ibb.co/84Kf9Rd0/552183644-17852106906549939-7631989156897828754-n.webp', 'Fotografía', 52000, 4.7, 200, '12 horas', NULL, NULL, 'photos/LogoOficial.png', 'Aprende composición, iluminación y edición para obtener fotos de calidad profesional con cualquier dispositivo.'),
(5, 'Yoga y Bienestar Integral', 6, 'https://i.ibb.co/84Kf9Rd0/552183644-17852106906549939-7631989156897828754-n.webp', 'Salud', 30000, 4.9, 152, '8 horas', NULL, NULL, 'photos/LogoOficial.png', 'Rutinas de yoga, respiración y relajación para mejorar tu salud física y mental.'),
(6, 'Inglés Conversacional Intensivo', 6, 'https://i.ibb.co/84Kf9Rd0/552183644-17852106906549939-7631989156897828754-n.webp', 'Idiomas', 70000, 4.4, 98, '20 horas', NULL, NULL, 'photos/LogoOficial.png', 'Desarrolla fluidez en inglés con ejercicios prácticos de conversación en situaciones reales.'),
(7, 'Excel Avanzado para el Trabajo', 6, 'https://i.ibb.co/84Kf9Rd0/552183644-17852106906549939-7631989156897828754-n.webp', 'Ofimática', 40000, 4.6, 261, '14 horas', NULL, NULL, 'photos/LogoOficial.png', 'Funciones avanzadas, tablas dinámicas y automatización para mejorar tu productividad laboral.');
...
INSERT INTO `detail_courses` (`id`, `course_id`, `learning_objectives`, `requirements`, `intro_video`, `recursos`) VALUES
(1, 1, '[\"Integrar el arte y la emoción como vehículos de aprendizaje\",\"Desarrollar habilidades socioemocionales y comunicativas\",\"Profesionalizar la gestión del artista educador\",\"Aplicar estrategias de inclusión y neuroeducación\"]', '[\"Experiencia docente (deseable)\",\"Interés en desarrollo personal\",\"Compromiso de 5-7 hrs\\/semana\"]', 'https://youtu.be/u_Ij1Kkd9Q0', 'https://drive.google.com/drive/u/1/folders/11fhFu6VZtAMClQnhxIgMRXwmjlq2neA3'),
(2, 2, '[\"obj1\",\"obj2\"]', '[\"req1\",\"req2\"]', 'https://www.youtube.com/watch?v=BBXoKa8RCZw', 'https://www.youtube.com/watch?v=oTZh02ubIpc');
...
--
-- FK: role_permissions → roles, permissions
--
ALTER TABLE `role_permissions`
...
--
-- FK: lessons.course_id → courses.id
--
ALTER TABLE `lessons`
  ADD CONSTRAINT `lessons_ibfk_1` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE CASCADE;

--
-- FK: lesson_progress → enrollments, lessons
--
ALTER TABLE `lesson_progress`
