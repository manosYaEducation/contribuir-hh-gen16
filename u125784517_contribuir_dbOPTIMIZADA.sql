...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-03-2026 a las 16:23:22
...
(1, 'Formación de Artistas Educadores', 10, 'https://i.ibb.co/84Kf9Rd0/552183644-17852106906549939-7631989156897828754-n.webp', 'educacion', 20000, 4.9, 204, '28 horas', NULL, NULL, 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=600&h=400&fit=crop', 'Somos una iniciativa pionera en Chile impulsada por CREO de Creer y Crear, Con Tribu Ir y la Red de Artistas Educadores de Chile (RAECH). Su propósito es profesionalizar y fortalecer el rol del \"Artista Educador\", integrando el arte no solo como una técnica, sino como una herramienta pedagógica para la educación emocional y la transformación social. El programa combina modelos teóricos, herramientas de gestión práctica (como formalización y planificación) y enfoques inclusivos (DUA y neurociencias) para preparar a los artistas en el desarrollo de experiencias educativas significativas en contextos escolares, culturales y psicosociales.'),
(2, 'Trabajo Colaborativo en I+D Aumentado con IA', 11, 'photos/LogoAlphadocere.png', 'Innovación y Tecnología', 0, 4.8, 121, '4 semanas', NULL, NULL, 'photos/LogoAlphadocere.png', 'Curso online de 4 semanas enfocado en aprender a trabajar colaborativamente en entornos de investigación y desarrollo (I+D) utilizando inteligencia artificial como apoyo. Los participantes aprenderán a transformar ideas en problemas estructurados, formular hipótesis, documentar de manera clara, iterar con feedback y definir un camino personal dentro del ecosistema de innovación. No se requiere experiencia técnica previa.');
-- --------------------------------------------------------
...
(1, 1, '[\"Integrar el arte y la emoci\\u00f3n como veh\\u00edculos de aprendizaje\",\"Desarrollar habilidades socioemocionales y comunicativas\",\"Profesionalizar la gesti\\u00f3n del artista educador\",\"Aplicar estrategias de inclusi\\u00f3n y neuroeducaci\\u00f3n\"]', '[\"Experiencia docente (deseable)\",\"Inter\\u00e9s en desarrollo personal\",\"Compromiso de 5-7 hrs\\/semana\"]', 'https://youtu.be/u_Ij1Kkd9Q0', 'https://drive.google.com/drive/folders/15QxCyviXQeZevDOchR9OPEKhDDNPU2KQ?usp=sharing'),
...
(5, 'Arturo Quiroga Tello', 'arturoquiroga93@gmail.com', '$2y$10$pNs4w/ZlsaLDbmNXpZpll.0vCSQNkWlmciQKJFYihxVRagL2uTr8y', 1, NULL, NULL, NULL, NULL, '2026-02-13 13:46:29'),
...
(7, 'ADMINISTRADOR', 'admin@admin.cl', '$2y$10$mQGj4SGRusYWYOQuNK7/1.UaptKl7VeGq3KoGWbVgT96xwbz3FcMK', 1, NULL, NULL, NULL, NULL, '2026-03-12 14:21:15'),
(10, 'ongcontribuir', 'ongcontribuir@gmail.com', '$2y$10$/NwFz2fk587NDZKorwqWp.u4rosTHbpbxZV.4SrSNcBilKW4S4CMu', 1, NULL, NULL, NULL, NULL, '2026-03-12 14:28:45'),
(11, 'Alpha Docere', 'alphadocere@gmail.com', '$2y$10$D/tHuNwTnqJCfczpDyKx3eAL0aKbEc2IM31/fk5lIBVl3MpObtd9S', 1, NULL, NULL, NULL, NULL, '2026-03-12 14:32:32'),
(12, 'Profesor/instructor', 'profe@profe.cl', '$2y$10$pDCiN9hXtiaoamV1UdPiseqHVtJmUKGEBwObNYH0C2vAp6pRBI9QW', 2, NULL, NULL, NULL, NULL, '2026-03-12 14:43:52');
